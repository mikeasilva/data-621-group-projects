...
density_models <- glm(target ~ nox_density +indus_density+age_density+dis_density+rad_density+tax_density+ptratio_density+lstat_density+medv_density+zn_density+rm_density+divider, family = binomial(link = "logit"), train)
