...
The challenge will be to create a classifier.  Let's explore the correlations to see what is correlated:

```{r, null_prefix = TRUE}
amt_train %>%
  keep(is.numeric)%>%
  select(-TARGET_AMT_OUTLIER, -INDEX) %>%
  cor(., amt_train$TARGET_AMT_OUTLIER) 
