...
This model says that the average baseball team will win about `r round(coef(fit)[1],0)` games.  If their batting is one standard deviation better than the average they will win `r round(coef(fit)[2],0)` more games.  