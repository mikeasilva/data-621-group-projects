...
\item
  C4.5 (Seewald, 2000), (Rickets, 2000);
\item
  Evolutionary Algorithm (Koudijs, 2000);
\item
  Fuzzy Classifier (János Abonyi, 2000);
\item
  Genetic Algorithms and Hill-climbers (Carter, 2000);
\item
  Inductive Learning by Logic Minimization (ILLM) (Gamberger, 2000);
\item
  K-Means (Vesanto \& Sinkkonen, 2000);
\item
  KXEN (Bera \& Lamy, 2000);
\item
  Mask Perceptron with Boosting (Leckie \& Ferra, 2000);
\item
  Midos Algorithm (Krogel, 2000);
\item
