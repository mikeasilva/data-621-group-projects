...
A logistic regression based solution to the CoIL Challenge 2000 is described in this paper. The challenge consists of correctly identifying potential customers for an insurance product, and describing their characteristics. Models were trained on over sampled data.  The model out preformed other's attemps.
