...
ggplot(data=prediction_scores, aes(x=score, y=n)) +
  ...
  ylab("Submissions") +
  xlim(37, 122) +
  ggtitle("Correct Predictions from CoIL 2000 Challenge Submissions")
```
...
#knitr::kable(data_dictionary, "latex", longtable = T) %>%
#  kable_styling(latex_options = c("repeat_header"))
apa_table(data_dictionary, longtable = T, booktabs = T, caption = "Data Dictionary")
```
